...
class PostProcessingException : public std::runtime_error
{
public:
  explicit PostProcessingException(const std::string & message)
  : std::runtime_error("Post-processing Error: " + message) {}
};
