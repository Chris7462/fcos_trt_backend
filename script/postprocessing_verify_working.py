...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        print(f"The first 20 values of boxes = {custom_results['boxes'][:20]}")
        print(f"The first 20 values of scores = {custom_results['scores'][:20]}")
        print(f"The first 20 values of labels = {custom_results['labels'][:20]}")
