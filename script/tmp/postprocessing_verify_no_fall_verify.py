...
def run_inference_comparison(image_path, onnx_path, height, width, confidence_threshold=0.5, tolerance=1e-4):
    ...
    # Load and preprocess image for ONNX model with specific dimensions
    ...
    print("\n=== Running ONNX Model + PostProcessor ===")
    ...
    if results_match:
        ...
        print(f"❌ MISMATCH: ONNX model + postprocessing differs from original FCOS.")
        print("This could indicate numerical precision issues in the ONNX model.")
        print("Check the ONNX export process for potential issues.")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Verify FCOS postprocessing with ONNX model')
